...
from Reward.reward         import reward_function as r_func
from StateReduction.state  import  state_function as s_func
...
class SimulatedNetworkSync(gym.Env):
    ...
    def __init__(self,action_dim,state_dim,stim_period=250.,reward_function=None,state_function=None):
    ...
    def step(self,action):
        ...
        # Define the space
        self.state  = self.state_function(response,self.state_dim)
        
        # Calculate reward
        self.reward = self.reward_function(response)
